                    ...
                    child: Container(
                      child: Column(children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            // Wrap in a Container for height and padding control
                            ...
                            child: DropdownButtonFormField2(
                              ...
                              items: genderItems
                                ...
                                value: item,
                                child: Row(
                                  // Use a Row for icon and text
                                  children: [
                                    Icon(Icons
                                        .person), // Add your desired icon here
                              ...
                              items: FromCity.map((item) =>
                                  DropdownMenuItem<String>(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Icon(Icons
                                            .location_city), // Add your desired icon here
                                        const SizedBox(width: 10),
                                        Text(
                                          item,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: DropdownButtonFormField2(
                              ...
                              items:
                              ToCity.map((item) => DropdownMenuItem<String>(
                                value: item,
                                child: Row(
                                  // Use a Row for icon and text
                                  children: [
                                    Icon(Icons
                                        .arrow_drop_down), // Place the icon here
                                    const SizedBox(width: 10),
                                    Text(
                                      item,
                                      style:
