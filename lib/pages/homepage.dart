                            ...
                            children: [
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(data['fromcity'],style: const TextStyle(fontSize: 30,fontWeight: FontWeight.w800 ),),
                                    const Icon(Icons.arrow_right_alt_rounded),
                                    Text(data['tocity'],style: const TextStyle(fontSize: 30,fontWeight: FontWeight.w800),),
                                  ],
                                ),
                              ),
